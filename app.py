...
with col1:
    with st.expander("Фильтры первого уровня"):
        ...
        with st.form(key="filters_form_1"):
            ...
            beta1, beta2 = st.columns([1, 1])
            with beta1:
                beta_min = st.number_input("Бета компании От", value=None)
            with beta2:
                beta_max = st.number_input("Бета компании До", value=None)
